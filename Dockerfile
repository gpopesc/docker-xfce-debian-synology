...
RUN wget -q -P /tmp https://gpopesc.i234.me/old_root/wps/wps-office_11.1.0.11708.XA_amd64.deb && \
    wget -q -P /tmp https://gpopesc.i234.me/old_root/wps/icefact_1.5.3.3-1_amd64.deb
