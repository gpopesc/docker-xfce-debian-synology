...
RUN wget -q -P /tmp https://gpopesc.i234.me/old_root/wps/wps-office_11.1.0.11698.XA_amd64.deb && \
    wget -q -P /tmp https://gpopesc.i234.me/old_root/wps/icefact_1.4.1-1_amd64.deb
